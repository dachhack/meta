...
|---|---|---|---|---|---|
| stathead | ../stathead | Full-stack NFL fantasy research workbench — React app, daily data pipelines, ML models, MCP server — across redraft/dynasty/best-ball; hardening for public launch at stathead.app | 2026 draft-season feature work: SFB16 scoring + cheatsheet tab merged; SFB16 live-draft support in use | Near-daily Jul–Dec; maintenance-only offseason | 2026-08-02 |
